          ...
          <div className="flex h-16 items-center justify-between">
            ...
            <div className="flex items-center gap-6">
              ...
              <nav className="hidden md:flex items-center gap-6 text-sm font-medium text-muted-foreground ml-4">
                ...
                <NavLink to="/dashboard" className={({isActive}) => isActive ? "text-primary font-semibold" : "hover:text-foreground transition-colors"}>Community</NavLink>
            ...
            <div className="flex items-center gap-4">
              ...
              <Link to="/signal">
                <Button size="sm" className="shadow-subtle transition-all hover:-translate-y-0.5 hover:shadow-md">Submit Signal</Button>
              </Link>
            </div>
          </div>
        </div>
